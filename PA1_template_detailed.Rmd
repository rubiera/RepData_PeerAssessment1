...
```{r setup detailed, include=FALSE}
knitr::opts_chunk$set(echo = TRUE)
```

```{r library load detailed, warning=FALSE, message=FALSE}
library(tidyverse)
```
...
```{r data load detailed, warning=FALSE, cache=TRUE}
...
```{r data time range detailed, warning=FALSE}
...
```{r data na check detailed, warning=FALSE}
nrow(proj_data_mutated)
...
```{r data time plot detailed, warning=FALSE}
...
```{r data time plot no na detailed, warning=FALSE}
...
```{r data mean detailed, warning=FALSE}
...
```{r data median detailed, warning=FALSE}
